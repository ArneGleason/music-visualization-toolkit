# Opening performance v2: Claude execution handoff

Project: `C:/Users/arneg/OneDrive/Documents/ChatGPT/music-visualization-toolkit-video-generation`.

## Scope and current status

Ready for Claude, NOT submitted. Owner approved trying an expressive singing
performance after the closed-mouth listening plate missed words and felt uptight.
...
This supersedes the previous download-only handoff for the NEXT experiment.
Keep every earlier result unchanged. That earlier download task is already done.
...
Do NOT use opening_sync_test/closed_mouth.png. The still/acting package changes
together, so this experiment cannot isolate the starting pose from performance
direction as a causal factor. The vocal guide and all timing remain fixed.
...
Write repository files only inside out/opening_performance_v2/.
