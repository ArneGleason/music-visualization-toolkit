...
bpy.ops.wm.open_mainfile(filepath=str(o/'MonstersLoose-v57-countdown-planning.blend'))
...
s.frame_start=1;s.frame_end=2905;s.name='Monsters Loose v58 stronger enclosed reptile roar'
s.render.filepath=str(o/'MonstersLoose-v58-through-countdown-storyboard.mp4')
bpy.ops.file.make_paths_relative();bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v58-countdown-planning.blend'));bpy.ops.render.render(animation=True)
