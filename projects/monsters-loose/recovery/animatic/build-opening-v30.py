...
bpy.ops.wm.open_mainfile(filepath=str(o/'MonstersLoose-v29-through-habitats.blend'))
...
for st in seq:
 if st.type=='TEXT' and st.frame_final_start==1305:
  ...
  if st.channel==102:st.text='A mossy hand snatches the startled frog beneath the water.'
...
s.frame_start=1;s.frame_end=2461;s.name='Monsters Loose v30 swamp water reflections'
s.render.filepath=str(o/'MonstersLoose-v30-opening-through-habitats.mp4')
bpy.ops.file.make_paths_relative();bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v30-through-habitats.blend'));bpy.ops.render.render(animation=True)
