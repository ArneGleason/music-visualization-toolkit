...
bpy.ops.wm.open_mainfile(filepath=str(o/'MonstersLoose-v30-through-habitats.blend'))
...
s.frame_start=1;s.frame_end=2461;s.name='Monsters Loose v31 tour and aquarium reference'
s.render.filepath=str(o/'MonstersLoose-v31-opening-through-habitats.mp4')
bpy.ops.file.make_paths_relative();bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v31-through-habitats.blend'));bpy.ops.render.render(animation=True)
