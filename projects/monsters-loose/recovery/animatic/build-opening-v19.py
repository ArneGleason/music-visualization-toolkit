...
for st in seq:
    if st.channel==1 and st.frame_final_start==1033:st.frame_final_start=1041
...
s.name='Monsters Loose Arctic announcement review v19'
s.render.image_settings.media_type='VIDEO'
s.render.image_settings.file_format='FFMPEG'
s.render.filepath=str(o/'MonstersLoose-v19-opening-through-lab.mp4')
bpy.ops.file.make_paths_relative()
bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v19-arctic.blend'))
