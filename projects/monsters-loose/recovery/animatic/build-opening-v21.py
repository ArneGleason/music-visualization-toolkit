...
for st in list(seq):
    if st.channel==1 and st.frame_final_start in (1033,1103):seq.remove(st)
...
s.name='Monsters Loose Arctic announcement review v21'
s.render.image_settings.media_type='VIDEO'
s.render.image_settings.file_format='FFMPEG'
s.render.filepath=str(o/'MonstersLoose-v21-opening-through-lab.mp4')
bpy.ops.file.make_paths_relative()
bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v21-arctic.blend'))
