...
s.name='Monsters Loose Arctic announcement review v12'
s.render.image_settings.media_type='VIDEO'
s.render.image_settings.file_format='FFMPEG'
s.render.filepath=str(o/'MonstersLoose-v12-sign-through-arctic.mp4')
bpy.ops.file.make_paths_relative()
bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v12-arctic.blend'))
