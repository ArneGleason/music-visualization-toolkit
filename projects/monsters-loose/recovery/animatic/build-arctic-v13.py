...
for st in seq:
    if st.type=='TEXT' and st.frame_final_start==504:
        ...
        if st.channel==102:st.text='Harper listens, trying to make sense of the announcement.'
...
s.frame_start=504;s.frame_end=1032
s.name='Monsters Loose Arctic announcement review v13'
s.render.image_settings.media_type='VIDEO'
s.render.image_settings.file_format='FFMPEG'
s.render.filepath=str(o/'MonstersLoose-v13-sign-through-arctic.mp4')
bpy.ops.file.make_paths_relative()
bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v13-arctic.blend'))
