...
bpy.ops.wm.open_mainfile(filepath=str(o/'MonstersLoose-v33-through-habitats.blend'))
...
s.frame_start=1;s.frame_end=2461;s.name='Monsters Loose v34 tour beacon lights'
s.render.filepath=str(o/'MonstersLoose-v34-opening-through-habitats.mp4')
bpy.ops.file.make_paths_relative();bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v34-through-habitats.blend'));bpy.ops.render.render(animation=True)
