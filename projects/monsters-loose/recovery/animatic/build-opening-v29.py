...
bpy.ops.wm.open_mainfile(filepath=str(o/'MonstersLoose-v28-through-habitats.blend'))
...
s.frame_start=1;s.frame_end=2461;s.name='Monsters Loose v29 swamp beacon lights'
s.render.filepath=str(o/'MonstersLoose-v29-opening-through-habitats.mp4')
bpy.ops.file.make_paths_relative();bpy.ops.wm.save_as_mainfile(filepath=str(o/'MonstersLoose-v29-through-habitats.blend'));bpy.ops.render.render(animation=True)
