...
folder=out/('reaction-overlay' if reaction else 'pa-frames')
folder.mkdir(exist_ok=True)
s.render.image_settings.file_format='PNG'
s.render.image_settings.color_mode='RGBA'
s.render.filepath=str(folder/'frame-')
s.frame_set(24)
bpy.ops.wm.save_as_mainfile(filepath=str(out/('Reaction-announcement-v001.blend' if reaction else 'Arctic-PA-v001.blend')))
