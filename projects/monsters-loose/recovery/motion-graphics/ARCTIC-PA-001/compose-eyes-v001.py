...
run([*inputs,'-filter_complex',graph,'-map','[v]','-map','[audio]','-c:v','libx264','-crf','17','-preset','fast','-pix_fmt','yuv420p','-c:a','aac','-b:a','320k','-movflags','+faststart',str(o/'Arctic-patrol-announcement-reaction-v003.mp4')])
