...
for i,rows in tracks.items():
 ...
 mute.scale=(5,5,1);ma.default_value=.94
 halo,ha=patch('Beacon %s bloom'%i,(1,.014,.002));halo.scale=(8,8,1)
 core,ca=patch('Beacon %s red lamp'%i,(1,.025,.004));core.scale=(2.7,2.7,1)
 hot,wa=patch('Beacon %s hot center'%i,(1,.35,.14));hot.scale=(1.2,1.2,1)
...
bpy.ops.wm.save_as_mainfile(filepath=str(o/'OPEN-LANDING-beacons-v001.blend'))
