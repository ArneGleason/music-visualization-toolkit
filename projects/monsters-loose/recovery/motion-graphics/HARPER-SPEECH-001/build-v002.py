...
segments=[((-3.12,-.30),(-3.40,.18),(-3.06,.73),(-2.35,.90)),((-2.35,.90),(-1.37,1.20),(.77,1.14),(2.25,.94)),((2.25,.94),(3.04,.83),(3.47,.39),(3.36,-.12)),((3.36,-.12),(3.30,-.64),(2.73,-.96),(1.87,-1.00)),((1.87,-1.00),(.54,-1.10),(-.89,-1.03),(-1.85,-.88)),((-1.85,-.88),(-2.50,-.86),(-3.39,-1.33),(-4.00,-1.48)),((-4.00,-1.48),(-3.54,-1.05),(-3.24,-.81),(-2.79,-.61)),((-2.79,-.61),(-2.94,-.52),(-3.05,-.42),(-3.12,-.30))]
points=[]
...
s.render.image_settings.file_format='PNG';s.render.image_settings.color_mode='RGBA';s.render.filepath=str(o/'frames-v002/bubble-');s.frame_set(35)
bpy.ops.wm.save_as_mainfile(filepath=str(o/'Harper-speech-v002.blend'));bpy.ops.render.render(animation=True)
