...
selections={1:{'frames':76,'map':[(0,12),(12,24),(75,68)]},2:{'frames':66,'map':[(0,18),(65,83)]},3:{'frames':66,'map':[(0,22),(18,42),(35,80),(65,110)]}}
w,h=1280,720;size=w*h*3
for n,sel in selections.items():
 src=r/f'video-tests/KLING-NEARMISS-{n}-001/KLING-NEARMISS-{n}-001-01.mp4'
 raw=subprocess.check_output(['ffmpeg','-v','error','-i',str(src),'-vf',f'scale={w}:{h}','-f','rawvideo','-pix_fmt','rgb24','-'])
 count=len(raw)//size;keys=sel['map'];target=o/f'nearmiss-{n}-timed-v001.mp4'
