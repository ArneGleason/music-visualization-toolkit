...
timing=json.loads((o/'timing-v002.json').read_text());hits=timing['impact_source_frames_one_based']
...
folder=o/'frames-v002';folder.mkdir(exist_ok=True)
s.render.image_settings.file_format='PNG';s.render.filepath=str(folder/'gate-')
bpy.ops.wm.save_as_mainfile(filepath=str(o/'Zone8-gate-rattle-v002.blend'))
