...
head_keys=[(1,0,0,0),(22,0,0,0),(48,.08,-.035,.035),
           (74,.21,-.13,.07),(94,.26,-.17,.08),(121,.26,-.17,.08)]
...
s.render.filepath=str(root/'frames-v003'/'bubble-')
s.frame_set(50)
bpy.ops.wm.save_as_mainfile(filepath=str(root/'Harper-thought-bubble-v003.blend'))
