...
args = ['image_to_video', '--image', str(root.parent/'assets'/'SCN-001-opening-heli-v001.png'), '--model', 'kling-video-v3_0', '--duration', '5', '--resolution', '1080p', '--imageCount', '1', '--enable_audio', 'false', '--prefer_multi_shots', 'false', prompt]
(out/'request.json').write_text(json.dumps({'source':'SCN-001-opening-heli-v001.png','expected_credits_based_on_previous_test':40,'cli_args':args},indent=2),encoding='utf-8')
