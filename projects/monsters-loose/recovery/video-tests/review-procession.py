...
r=Path('C:/audio/shared/amtw-runtime/jobs/monsters-loose-word-timing-20260913');o=r/'motion-graphics/SCENE12-PROCESSION-001';o.mkdir(exist_ok=True)
p=r/'video-tests/KLING-SCENE12-PROCESSION-001/KLING-SCENE12-PROCESSION-001-01.mp4'
im=Image.new('RGB',(1280,660))
for i,f in enumerate(range(0,288,24)):
