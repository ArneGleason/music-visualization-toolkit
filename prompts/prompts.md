...
## `astronomer_desk_sync`  ·  performance
...
## `astronomer_close_sync`  ·  performance
...
## `astronaut_close_sync`  ·  concept, performance
...
## `astronaut_inspect_medium`  ·  performance
...
## `astronaut_mars_medium`  ·  performance
...
## `weather_over_colony`  ·  concept

Used by 1 cut(s): s029 (5.7s)
Sections: semantic-rocket-weather · **generate ≥ 5.7s**
...
## `duet_call_response_sync`  ·  performance

Used by 1 cut(s): s030 (5.7s)
Sections: semantic-rocket-weather · **generate ≥ 5.7s**
...
## `rockets_overhead`  ·  concept

Used by 1 cut(s): s031 (5.7s)
Sections: semantic-rocket-weather · **generate ≥ 5.7s**
...
## `canal_moon_descent`  ·  concept

Used by 1 cut(s): s033 (5.7s)
...
## `duet_canal_bank_sync`  ·  performance

Used by 1 cut(s): s034 (5.7s)
Sections: rivers-of-mars · **generate ≥ 5.7s**
...
## `canal_current_macro`  ·  concept

Used by 2 cut(s): s035 (5.7s), s041 (2.9s)
Sections: current-turns-home, rivers-of-mars · **generate ≥ 5.7s**
...
## `creature_swim_macro`  ·  performance
...
## `chorus_plunge`  ·  concept

Used by 1 cut(s): s039 (2.8s)
...
## `canal_junction_turn`  ·  concept

Used by 1 cut(s): s040 (2.8s)
...
## `duet_lamplight_astronomer_sync`  ·  performance

Used by 2 cut(s): s042 (5.7s), s045 (5.9s)
...
## `duet_lamplight_astronaut_sync`  ·  performance

Used by 1 cut(s): s043 (5.7s)
...
## `telescope_time_tunnel`  ·  concept

Used by 1 cut(s): s044 (5.8s)
...
## `colony_goodnight_cascade`  ·  concept

Used by 1 cut(s): s046 (3.0s)
...
## `night_iris_title`  ·  concept

Used by 1 cut(s): s047 (5.9s)
